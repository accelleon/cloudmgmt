...
class CRUDUser(CRUDBase[User, CreateUser, UpdateUser]):
    ...
    def update(
        ...
        *, # Skip unnamed parameters
        ...
        update_data['password'] = hash_password(update_data['password']) if update_data['password'] else None

        # Are we modifying the twofa_enabled field?
        if update_data['twofa_enabled'] is not None and update_data['twofa_enabled'] != db_obj.twofa_enabled:
