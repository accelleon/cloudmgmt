  ...
  >
    ...
    <q-card class="q-dialog-plugin">
      ...
      <q-card-section horizontal>
        ...
        <q-card-section>
          <div class="q-pa-md">Scan the QR code to the right with you're prefered Google compatible Authenticator app</div>
  ...
  setup() {
    ...
    return {
      ...
      async onShow(evt) {
        ...
        await store.enableTwoFa().then(twofa_uri => {
          if (!twofa_uri) {
      ...
      async onSubmit() {
        ...
        if (!codeRef.value.hasError) {
          await store.enableTwoFa(code.value).then(() => {
